...
public final class MockUtils {
    ...
    /**
     * Produce a shallow copy of an instance. USE WITH EXTRA CARE!!! It can bring
     * a lot of surprises, with trivial and non-trivial objects! You have to clearly 
     * understand what is going on if you use the method.
     * @param e an instance to be copied
