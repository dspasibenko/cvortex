...
public class TaskHolderTest extends Assert implements OfferResultListener {

    private final OfferParams offerParams = new OfferParams(new TimeInterval(0L), this, 0);
    
    private final AutomaticTaskDistributorImpl atd = mock(AutomaticTaskDistributorImpl.class);
